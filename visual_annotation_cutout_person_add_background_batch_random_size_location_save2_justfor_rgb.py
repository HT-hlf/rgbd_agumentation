...
# dst_background_depth_path=r'G:\lab_collect_dataset\roadway_background_for_aug\1\depth'
# dst_background_rgb_path=r'G:\lab_collect_dataset\roadway_background_for_aug\1\rgb'
dst_background_depth_path=r'G:\kitti_depth\KITTI_BatchDepthMap_Generator-main\KITTI_BatchDepthMap_Generator-main\Data\2011_10_03\2011_10_03_drive_0027_sync\image_02\data'
dst_background_rgb_path=r'G:\kitti_depth\KITTI_BatchDepthMap_Generator-main\KITTI_BatchDepthMap_Generator-main\Data\2011_10_03\2011_10_03_drive_0027_sync\image_02\data'
dst_background_depth_list=os.listdir(dst_background_depth_path)

save_path=r'G:\lab_collect_dataset\background_aug\RGBD_background_aug_kitti_rgb'
...
for raw_root_element in raw_root_list:
    ...
    for i in range(len(rgb_image_list_1)):
        ...
        save_rgb_path_f = save_rgb_path+'/'+'rgb_'+random_rgb_1.rstrip('.jpg')+'_bg_aug_'+random_depth_2.rstrip('.png')+'.jpg'
        save_depth_path_f = save_depth_path+'/'+'rgb_'+random_rgb_1.rstrip('.jpg')+'_bg_aug_'+random_depth_2.rstrip('.png')+'.jpg'
        save_anno_name=random_rgb_1.rstrip('.jpg') + '_bg_aug_' + random_depth_2.rstrip('.png') + '.xml'
        save_anno_path_f = save_anno_path+'/'+'rgb_'+save_anno_name
        ...
        random_dst_background_depth = random_dst_background_depth[:,:417,0:3]
        random_dst_background_rgb = random_dst_background_rgb[:,:417,0:3]

        # 创建0值深度图
        random_dst_background_depth_for_rgb = np.zeros_like(random_dst_background_depth)
        ...
        #设置随机，使人体形状和大小变化
        background_shape_h_random=random.randint(int(background_shape_h*0.3),int(background_shape_h*0.8))
        ...
        for i in range(cimg_h):
            for j in range(cimg_w):
                ...
                if cimg[i, j, 0] == 255:
                    ...
                    random_dst_background_depth[dst_loc_y+i, dst_loc_x+j, 0:3] = depth_image_data_1_person_raw[i,j,0:3]

        random_aug_blur=random.randint(1,5)
        ...
        # select_random = random.randint(1, 2)
        # if select_random == 1:
        ...
        cv2.imwrite(save_depth_path_f, random_dst_background_depth_for_rgb)
