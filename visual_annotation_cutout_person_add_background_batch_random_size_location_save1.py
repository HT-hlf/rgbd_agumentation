...
save_path=r'G:\lab_collect_dataset\background_aug\RGBD_background_aug_roadway'
...
for raw_root_element in raw_root_list:
    ...
    for i in range(len(rgb_image_list_1)):
        ...
        save_rgb_path_f = save_rgb_path+'/'+random_rgb_1.rstrip('.jpg')+'_bg_aug_'+random_depth_2.rstrip('.jpg')+'.jpg'
        save_depth_path_f = save_depth_path+'/'+random_rgb_1.rstrip('.jpg')+'_bg_aug_'+random_depth_2.rstrip('.jpg')+'.jpg'
        ...
        #设置随机，使人体形状和大小变化
        background_shape_h_random=random.randint(int(background_shape_h*0.3),int(background_shape_h*0.6))
        ...
        random_aug_blur=random.randint(2,7)
        random_aug_blur1 = random.randint(3, 7)
        ...
        select_random = random.randint(1, 4)
        if select_random == 1:
