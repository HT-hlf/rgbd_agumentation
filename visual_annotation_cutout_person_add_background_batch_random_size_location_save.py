...
save_path=r'G:\lab_collect_dataset\background_aug\RGBD_background_aug'
...
for raw_root_element in raw_root_list:
    ...
    for i in range(len(rgb_image_list_1)):
        ...
        save_rgb_path_f = save_rgb_path+'/'+random_rgb_1.rstrip('.jpg')+'_bg_aug_'+random_depth_2.rstrip('.png')+'.jpg'
        save_depth_path_f = save_depth_path+'/'+random_rgb_1.rstrip('.jpg')+'_bg_aug_'+random_depth_2.rstrip('.png')+'.jpg'
