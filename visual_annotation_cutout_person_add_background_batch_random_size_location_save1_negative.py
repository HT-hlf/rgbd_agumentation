...
st_background_depth_path=r'G:\lab_collect_dataset\roadway_background_for_aug\1\depth'
dst_background_rgb_path=r'G:\lab_collect_dataset\roadway_background_for_aug\1\rgb'

dst_background_depth_list=os.listdir(dst_background_depth_path)

negative_root_path=r'G:\lab_collect_dataset\recordData_process_annotation_light_daytime - for_aug-negative_useful\1'
...
save_path=r'G:\lab_collect_dataset\background_aug_negative2\RGBD_background_aug_roadway'
...
for raw_root_element in raw_root_list:
    ...
    for i in range(len(rgb_image_list_1)):
        ...
        random_dst_background_rgb_all_name = dst_background_rgb_path + '/' + random_depth_2.rstrip('jpg')+'jpg'
        # print(random_dst_background_rgb_all_name )

        save_rgb_path_f = save_rgb_path+'/'+'bg_aug_'+random_rgb_1.rstrip('.jpg')+random_depth_2.rstrip('.jpg')+'.jpg'
        save_depth_path_f = save_depth_path+'/'+'bg_aug_'+random_rgb_1.rstrip('.jpg')+random_depth_2.rstrip('.jpg')+'.jpg'
        save_anno_name='bg_aug_'+random_rgb_1.rstrip('.jpg')  + random_depth_2.rstrip('.jpg') + '.xml'
...
##rgb
            ...
            for k in range(random.randint(2, 6)):
                background_shape_h_random_n = random.randint(int(background_shape_h * 0.2),
                                                             int(background_shape_h * 0.35))
                background_shape_w_random_n = int(
                    cimg_w / cimg_h * background_shape_h_random_n * random.uniform(0.8, 1.1))
