...
dst_background_depth_path=r'G:\kitti_depth\aug_dataset\depth'
dst_background_rgb_path=r'G:\kitti_depth\aug_dataset\rgb'
...
save_path=r'G:\lab_collect_dataset\background_aug_negative2\RGBD_background_aug_kitti'
...
for raw_root_element in raw_root_list:
    ...
    for i in range(len(rgb_image_list_1)):
        ...
        # cv2.imshow('rgb_image_data_1', rgb_image_data_1)
        ...
        #设置随机，使人体形状和大小变化
        background_shape_h_random_n=random.randint(int(background_shape_h*0.2),int(background_shape_h*0.8))
        background_shape_w_random_n=int(cimg_w/cimg_h*background_shape_h_random_n*random.uniform(0.8,1.1))
...
#####
        ...
        for k in range(random.randint(2, 5)):
            background_shape_h_random_n = random.randint(int(background_shape_h * 0.2), int(background_shape_h * 0.35))
        ...
        #     for l in range(random.randint(0, 4)):
...
##rgb
        ...
        #     background_shape_h_random_n = random.randint(int(background_shape_h * 0.1), int(background_shape_h * 0.4))
        #     background_shape_w_random_n = int(cimg_w / cimg_h * background_shape_h_random_n * random.uniform(0.8, 1))
        #     print(background_shape_h_random_n, background_shape_w_random_n)
        #     if background_shape_w_random_n == 0:
        #         background_shape_w_random_n = 32
        ...
        #     cimg_n = cv2.resize(cimg_n, (dst_w_n, dst_h_n))
        #
        #     dst_loc_x_max1 = (background_shape_w) if (background_shape_w - (dst_loc_x_r+cimg_w_r))>dst_loc_x_r else dst_loc_x_r
        #     dst_loc_x_min1 = (dst_loc_x_r+cimg_w_r) if (background_shape_w - (dst_loc_x_r+cimg_w_r))>dst_loc_x_r else 0
        #
        #
        #     dst_loc_x_max = dst_loc_x_max1 - background_shape_w_random_n
        #     dst_loc_y_max = background_shape_h - background_shape_h_random_n
        #     dst_loc_x_n, dst_loc_y_n = random.randint(dst_loc_x_min1, dst_loc_x_max), random.randint(0, dst_loc_y_max)
        #
        #     # dst_loc_x_n_r, dst_loc_y_n_r = random.randint(0, dst_loc_x_max), random.randint(0, dst_loc_y_max)
        #     #
        #     # # cv2.imshow('cimg', cimg)
        #     # # cv2.imshow('depth_image_data_1_person_raw', depth_image_data_1_person_raw)
        #     # # cv2.imshow('rgb_image_data_1_person', rgb_image_data_1_person)
        ...
        #             #     depth_image_data_1_person_threshold_three_chan[i,j,0:3]=0
        #             if cimg_n[i, j, 0] == 255:
        #                 random_dst_background_rgb[dst_loc_y_n+i, dst_loc_x_n+j, 0:3] = rgb_image_data_1_person_n[i,j,0:3]
        #                 # random_dst_background_depth[dst_loc_y_n + i, dst_loc_x_n + j,
        #                 # 0:3] = 0.1 * random_value * depth_image_data_1_person_raw_n[i, j, 0:3]
        #         # for i in range(cimg_h1):
        #         #     for j in range(cimg_w1):
        ...
        random_aug_blur=random.randint(1,4)
